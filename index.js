...
// No, the for loop is written as O(n). The code written inside prevents it from exceeding past 4th loop.
...
// ANSWER: they are dependent on the size of the passed in string. 
